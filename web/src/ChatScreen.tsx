...
import {
  ...
  Users, Send, Share2, Copy, Check, Trash2, Sparkles, MapPin, ClipboardList,
} from 'lucide-react'
import type { AssistPlace, ClientConfig, PresentedEntry } from './api'
...
// 用的命名規則都不會產生底線開頭的字串)。
const ENTRY_QUERY_BATCH_KEY = '_entry_query'
